...
;;;; List of configuration layers to load.
   ...
   dotspacemacs-additional-packages '(pydoc cuda-mode cheat-sh graphql-mode flycheck-cython academic-phrases jupyter el-patch)

   ;; A list of packages that cannot be updated.
   dotspacemacs-frozen-packages '()

   ;; A list of packages that will not be installed and loaded.
   dotspacemacs-excluded-packages '(importmagic anaconda-mode org-bullets)
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-elpa-subdirectory '(concat emacs-version system-configuration)
...
before packages are loaded."
  ...
  ;; Set TZ=UTC when invoking external processes
  (setq process-environment (cons "TZ=UTC" process-environment))
  ...
  ;; Cuda
  ;; https://github.com/syl20bnr/spacemacs/issues/1815
